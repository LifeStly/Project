...
import com.example.moveproject.R
import com.example.moveproject.data.MovieApi.POSTER_BASE_URL
import com.example.moveproject.data.MovieApi.TheMovieDBClient
...
class SingleMovie : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val apiService : TheMovieDBInterface = TheMovieDBClient.getClint()
        movieRepository = MovieDetailRepository(apiService)

        viewModel = getViewModel(movieId)

        viewModel.movieDetailData.observe(this, androidx.lifecycle.Observer{
            bindUI(it)
        })
